...
#if 1
#define VIDEO_KEY				IO_D11
#define MOTION_KEY				IO_A0
...
#define FUN_KEY 				IO_F15// IO_C15// IO_B2
#define FUN_KEY1				IO_F15

//#define FUN_KAYA					 IO_F15
//A键直接扫描POWEN键，合在一起
#define FUN_KEYB				IO_B3
#define FUN_KEYC				IO_C13
#define FUN_KEYD				IO_C12

#define IRCTR_KEY				IO_F15//	 IO_B3

#define FUN_KEY_ACTIVE			0
#define FUN_KEY1_ACTIVE 		0 
#define FUN_KEYB_ACTIVE 		1
#define FUN_KEYC_ACTIVE 		1
#define FUN_KEYD_ACTIVE 		1



#define SCCB_SCL				IO_B1 // Sensor I2C clock pin
#define SCCB_SDA				IO_B0	// Sensor I2C data pin	
...
#define IR_CTRL 				IO_C14//ir light 
#define LED 					IO_F15

#define POWER_EN				IO_B2

#define LED1					IO_D10
#define LED2					IO_B5

#define CHARGE_PIN				IO_C13
#define ZD_PIN					IO_F15

#define CDSP_IQ 				GPCV1248_JVIN_V1_0//GPCV1248_C6_V2_0	
#define PRODUCT_NUM 			7525
#define PRODUCT_DATA			20170825
#define PROGRAM_VERSION_NUM 	31
#endif
